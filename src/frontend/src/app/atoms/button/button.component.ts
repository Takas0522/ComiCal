...
export class ButtonComponent {
  ...
  buttonClasses() {
    const base = 'inline-flex items-center justify-center font-medium rounded transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 disabled:opacity-50 disabled:cursor-not-allowed';
    ...
    const variants: Record<string, string> = {
      ...
      secondary: 'bg-[--color-surface-elevated] text-[--color-text-primary] border border-[--color-border] hover:bg-[--color-border]',
